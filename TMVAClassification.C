...
void TMVAClassification( TString myMethodList = "" )
{
   ...
   //factory->AddSpectator( "mgg",  "M_{#gamma#gamma}", "GeV", 'F' );

   // Read training and test data
   // (it is also possible to use ASCII format as input -> see TMVA Users Guide)
   TString fname = "TMVA_input_CMS-HGG_4686pb.root";
   ...
   TTree *signal_train     = (TTree*)input->Get("sig_train_123.0");
   TTree *signal_test      = (TTree*)input->Get("sig_test_123.0");
   TTree *background_train     = (TTree*)input->Get("bkg_train_all");
   TTree *background_test      = (TTree*)input->Get("bkg_test_all");
   ...
   TCut mycut = "fabs(deltaMOverM)<0.02"; 
